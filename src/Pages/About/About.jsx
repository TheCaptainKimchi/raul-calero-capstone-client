      ...
      <div className="about__developer">
        ...
        <div className="about__developer-me">
          ...
          <p className="about__developer-me-text">
            ...
            doloribus assumenda labore numquam! Eos molestias, praesentium
            reiciendis error aperiam ipsam fugit vero eaque veritatis atque aut
            eligendi dolorum illo facere?
          </p>
        </div>
